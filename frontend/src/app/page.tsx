      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
            AIエージェントを活用してスクラム開発プロセスを自律的に実行するタスク管理システム
          </p>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">プロジェクト管理</h3>
              <p className="text-gray-600">
                複数のプロジェクトを効率的に管理し、進捗を可視化します
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">タスク自動化</h3>
              <p className="text-gray-600">
                AIエージェントがタスクを自動的に実行し、開発を支援します
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
