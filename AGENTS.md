...
**このドキュメントに記載されたルールは、AGENTS.md自身の編集時も含め、すべての作業に適用されます。**

- **公式ドキュメントの参照**: コード、設定ファイル、ドキュメント編集など、あらゆる作業の前に関連する公式ドキュメントを確認
- **適切な粒度でのコミット**: 論理的な単位で変更をコミット（1コミット1変更）
...
- `roles.md`: 役割定義
- `backlog_management.md`: バックログアイテム管理の詳細
